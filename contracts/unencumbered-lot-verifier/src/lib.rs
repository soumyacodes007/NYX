...
const PROOF_TYPE_UNENCUMBERED_LOT: u32 = 3;
const STATEMENT_HASH_HI_INDEX: u32 = 6;
const STATEMENT_HASH_LO_INDEX: u32 = 7;
...
#[contract]
pub struct UnencumberedLotVerifier;

#[contractimpl]
impl UnencumberedLotVerifier {
    ...
    pub fn verify(env: Env, proof_type: u32, statement_hash: BytesN<32>, proof: Bytes) -> bool {
        if proof_type != PROOF_TYPE_UNENCUMBERED_LOT {
            return false;
        }
