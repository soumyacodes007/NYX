...
const PROOF_TYPE_PRIVATE_MATCH: u32 = 4;
const STATEMENT_HASH_HI_INDEX: u32 = 4;
const STATEMENT_HASH_LO_INDEX: u32 = 5;
const MIN_PUBLIC_SIGNAL_COUNT: u32 = 6;
...
#[contract]
pub struct PrivateMatchVerifier;

#[contractimpl]
impl PrivateMatchVerifier {
    ...
    pub fn verify(env: Env, proof_type: u32, statement_hash: BytesN<32>, proof: Bytes) -> bool {
        if proof_type != PROOF_TYPE_PRIVATE_MATCH {
            return false;
        }
