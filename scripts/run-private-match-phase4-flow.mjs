...
if (JSON.stringify(publicSignals) !== JSON.stringify(expected.publicSignals.map(String))) {
  throw new Error("Public signals did not match expected deterministic values");
}

console.log("\nPhase 4 Groth16 flow completed and public signals matched expected values.");
