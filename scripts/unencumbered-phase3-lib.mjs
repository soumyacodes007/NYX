...
export const artifactDir = path.join("circuits", "artifacts", "unencumbered_lot");
export const circuitName = "unencumbered_lot";
...
export async function writeFixtureInput(filename, optionsOrTransform) {
  const { transform, statementHashHex, participantIdHashHex } = resolveFixtureOptions(optionsOrTransform);
  const fixture = await buildUnencumberedLotFixture({
    statementHashHex,
