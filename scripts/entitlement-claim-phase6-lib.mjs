...
import { buildEntitlementClaimFixture } from "./entitlement-claim-input-lib.mjs";
...
export const artifactDir = namespace
  ? path.join("circuits", "artifacts", namespace, "entitlement_claim")
  : path.join("circuits", "artifacts", "entitlement_claim");
export const circuitName = "entitlement_claim";
...
export async function writeFixtureInput(filename, optionsOrTransform) {
  ...
  const fixture = await buildEntitlementClaimFixture(fixtureOptions);
